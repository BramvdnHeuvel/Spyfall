events = [
    ...
    },
    {
        ...
        'yes': ['Brom', 'Egdar', 'Riineer', 'Seneca'],
        'maybe': ["Harissa", "Mork", "Mickey", "Meesje"],
        'no': ['Swammy']
    },
    {
        'name': 'Escape room',
        'desc': 'Wat is er nou leuker dan een escape room doen? Het staat al zo lang in ons vizier, tijd om het nu ECHT te doen!',
        'yes': ['Brom', 'Swammy', 'Egdar'],
        'maybe': ["Harissa", "Mork", "Seneca", "Mickey", "Riineer", "Meesje"],
        'no': []
    },
    {
        ...
        'yes': ["Riineer", 'Brom', 'Seneca'],
        'maybe': ["Harissa", "Mork", "Egdar", "Mickey", "Meesje"],
        'no': ['Swammy']
    },
    {
        'name': 'Niks doen',
        'desc': 'Soms kan het zo simpel zijn.',
        'yes': ['Brom', 'Mork', 'Riineer'],
        'maybe': ["Harissa", "Egdar", "Mickey", "Meesje"],
        'no': ['Swammy', 'Seneca']
    },
    {
        ...
        'yes': ['Brom', 'Riineer'],
        'maybe': ["Harissa", "Mork", "Seneca", "Swammy", "Egdar", "Mickey", "Meesje"],
        'no': []
    },
    {
        'name': 'LAN Party',
