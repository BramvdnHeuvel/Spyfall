events = [
    ...
    },
    {
        ...
        'yes': ['Brom', 'Swammy'],
        'maybe': ["Harissa", "Mork", "Seneca", "Egdar", "Mickey", "Riineer", "Meesje"],
        'no': []
    },
    {
        'name': 'Poulen',
    ...
    },
    {
        ...
        'yes': ['Swammy', 'Riineer'],
        'maybe': ['Brom', "Harissa", "Seneca", "Egdar", "Mickey", "Meesje"],
        'no': ['Mork']
    },
    {
        'name': 'Hackathon',
