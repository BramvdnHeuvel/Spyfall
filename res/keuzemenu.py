events = [
    ...
    },
    {
        ...
        'yes': ["Riineer", 'Brom'],
        'maybe': ["Harissa", "Mork", "Seneca", "Egdar", "Mickey", "Meesje"],
        'no': ['Swammy']
    },
    {
        'name': 'Hackathon',
