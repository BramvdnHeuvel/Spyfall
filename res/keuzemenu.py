events = [
    {
        ...
        'yes': ['Brom', 'Egdar', 'Mork'],
        'probably': ['Meesje', 'Seneca'],
        'maybe': ['Riineer'],
        'hmm': [],
        'no': [],
        'NA': ["Harissa", "Swammy", "Mickey"],
    },
    {
    ...
    },
    {
        ...
        'yes': ['Brom', 'Riineer', 'Meesje', 'Seneca'],
        'probably': ['Egdar', 'Mork'],
        'maybe': [],
        'hmm': [],
        'no': [],
    ...
    },
    {
        ...
        'yes': [],
        'probably': ['Brom', 'Mork', 'Meesje', 'Seneca'],
        'maybe': ['Riineer', 'Egdar'],
        'hmm': [],
        'no': [],
        'NA': ["Harissa", "Swammy", "Mickey"],
    ...
    },
    {
        ...
        'hmm': ['Egdar', 'Seneca'],
        'no': [],
        'NA': ["Harissa", "Swammy", "Mickey", "Riineer"],
    },
    {
        ...
        'hmm': ['Brom'],
        'no': [],
        'NA': ['Riineer', "Harissa", "Swammy", "Mickey"],
    },
    {
        'name': 'Photo Shooter',
        ...
        'hmm': [],
        'no': [],
        'NA': ['Mork', 'Meesje', 'Egdar', 'Riineer', "Harissa", "Swammy", "Seneca", "Mickey"],
    }
]
